    ...
    const githubLink = useMemo(() => {
        ...
        return isDesktopApp() ? (
            <span
                ...
                onClick={() => {
                    // @ts-ignore
                    window.electronAPI.openBrowser("https://github.com/w-okada/asrclient");
                }}
            >
            ...
            <a className={tooltip} href="https://github.com/w-okada/asrclient" target="_blank" rel="noopener noreferrer">
                <img src={iconUrl} className={HeaderIcon()} />
                <div className={tooltipText}>{t("header_github")}</div>
            </a>
        );
        ...
        return (
            <div className={headerArea}>
                <div className={titleArea}>
                    <span className={title}>ASR Client</span>
                    <span></span>
